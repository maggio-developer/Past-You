...
/** @type {string} */
const CACHE_VERSION = '1773405548|1359393812';
/** @type {string} */
const CACHE_PREFIX = 'Past You Beta-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'pastyou.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["pastyou.html","pastyou.js","pastyou.offline.html","pastyou.icon.png","pastyou.apple-touch-icon.png","pastyou.audio.worklet.js","pastyou.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["pastyou.wasm","pastyou.pck"];
